package com.compass.ux.ui.window;
 ...
 * 失控返航
 */
public class DisconnectActionWindow {
    ...
    public DisconnectActionWindow( Activity context) {
     ...
     * @param adapter
     */
    public  void showView(final View v, ArrayAdapter adapter,final OnDisconnectActionSelectedListener listener) {
        View contentView = LayoutInflater.from(context).inflate(
                R.layout.window_disconnect_action, null);
        ...
        // 我觉得这里是API的一个bug
        popupWindow.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.bg_spinner));
