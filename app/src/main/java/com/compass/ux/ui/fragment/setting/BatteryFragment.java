    ...
    protected void initDatas() {
                    ...
                    public void onUpdate(BatteryState batteryState) {
                        if (getActivity()!=null){
                            getActivity().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    mBinding.tvBatteryQuantity.setText(batteryState.getChargeRemainingInPercent() + "%");
                                    mBinding.tvLowBatteryQuantityOne.setText(batteryState.getChargeRemainingInPercent() + "%");
                                    mBinding.tvFlightDischarges.setText(batteryState.getNumberOfDischarges()+"");
                                    ...
                                    mBinding.tvBatteryCycles.setText(batteryState.getLifetimeRemaining() + "%");
        ...
        if (Helper.isFlightControllerAvailable()) {
            ...
            flightController.getLowBatteryWarningThreshold(new CommonCallbacks.CompletionCallbackWith<Integer>() {
                @Override
                public void onSuccess(Integer integer) {                        if (getActivity()!=null){
            ...
            if (Helper.isFlightControllerAvailable()) {
                ...
                flightController.setSmartReturnToHomeEnabled(isChecked, new CommonCallbacks.CompletionCallback() {
                    ...
                    public void onResult(DJIError djiError) {
                        if (djiError != null) {                        if (getActivity()!=null){
