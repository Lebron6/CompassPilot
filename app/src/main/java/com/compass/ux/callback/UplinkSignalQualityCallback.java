...
//            builder.setQuality(0);
            DataCache.getInstance().setUplinkQuality(0);

        } else if (i > 0 && i <= 20) {
//            builder.setQuality(20);
            DataCache.getInstance().setUplinkQuality(1);

        } else if (i > 20 && i <= 40) {
//            builder.setQuality(2);
            DataCache.getInstance().setUplinkQuality(2);

        } else if (i > 40 && i <= 60) {
//            builder.setQuality(3);
            DataCache.getInstance().setUplinkQuality(3);

        } else if (i > 60 && i <= 80) {
//            builder.setQuality(4);
            DataCache.getInstance().setUplinkQuality(4);

        } else if (i > 80 && i <= 100) {
//            builder.setQuality(5);
            DataCache.getInstance().setUplinkQuality(5);
        }
//        if (isFlyClickTime()) {
